...
println("Second-run time (s): ", t)
println("PDB match warm vs second: ", pdb_1 == pdb_2)
println("Positions shape: ", size(out_2[:positions]))
println("PLDDT shape: ", size(out_2[:plddt]))
